...
namespace VRMS___Management__12_01_21_
{
    public partial class AddOwner : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (cmbOtype.Text == "")
            {
                MessageBox.Show("WALANG LAMAN YUNG COMBO BOX TANG INA MO");
            }else if(txtSchoolID.Text == ""){
                MessageBox.Show("WALANG LAMAN YUNG SCHOOLD ID TANG INA MO");
            }else if(txtLname.Text == ""){
                MessageBox.Show("WALANG LAMAN YUNG LAST NAME TANG INA MO");
            }else if(txtFname.Text == ""){
                MessageBox.Show("WALANG LAMAN YUNG FIRST NAME TANG INA MO");
            }else if(txtMname.Text==""){
                MessageBox.Show("WALANG LAMAN YUNG MIDDLE NAME TANG INA MO");
            }
            else
            {
                try
